...
use Altax\Server\SSHConfigParser;

class SSHConfigParserTest extends \PHPUnit_Framework_TestCase
{
    public function testParse() {
        $config = SSHConfigParser::parse(file_get_contents(__DIR__."/SSHConfigParserTest/ssh_config"));
//        print_r($config);
    ...
    public function testParseFromFiles() {
        $config = SSHConfigParser::parseFromFiles(array(
            __DIR__."/SSHConfigParserTest/ssh_config",
            __DIR__."/SSHConfigParserTest/ssh_config2",
            __DIR__."/SSHConfigParserTest/ssh_config3"
...
//        print_r($config);
    ...
    {
        $config = SSHConfigParser::parseToNodeOptionsFromFiles(array(
            __DIR__."/SSHConfigParserTest/ssh_config",
            __DIR__."/SSHConfigParserTest/ssh_config2",
            __DIR__."/SSHConfigParserTest/ssh_config3"
        ));
//        print_r($config);
    ...
    public function testParseWithSpeceialComment() {
        $config = SSHConfigParser::parse(file_get_contents(__DIR__."/SSHConfigParserTest/ssh_config4"));
//        print_r($config);
